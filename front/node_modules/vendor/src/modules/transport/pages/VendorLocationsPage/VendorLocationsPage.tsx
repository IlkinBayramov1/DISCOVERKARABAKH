                                        ...
                                        <tr key={id}>
                                            <td>
                                                <div className="loc-cell">
                                                    {loc.googleMapsUrl || (loc.coordinates?.lat && loc.coordinates?.lng) ? (
                                                        <a 
                                                            href={loc.googleMapsUrl || `https://www.google.com/maps?q=${loc.coordinates.lat},${loc.coordinates.lng}`}
                                                            target="_blank"
                                                            rel="noreferrer"
                                                            className={`loc-icon-box ${loc.type?.toLowerCase() || 'custom'}`}
