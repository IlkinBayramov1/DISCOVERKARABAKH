...
import './ProfilePage.css'; // Xüsusi DK stili
...
export const ProfilePage: React.FC = () => {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (res.success) {
                ...
                setSuccessMsg('Avatar uploaded! Click "Save Blueprint" to persist.');
            }
        } catch (err) {
    ...
    const handleDeleteAvatar = () => {
        ...
        setSuccessMsg('Photo removed! Click "Save Blueprint" to persist.');
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (res.success) {
            setSuccessMsg('Identity Blueprint successfully updated.');
        ...
        <div className="dk-profile-layout">
            <div className="dk-profile-container">
                ...
                <header className="dk-profile-header">
                    <div>
                        <h1 className="dk-title">Identity Blueprint</h1>
                ...
                <form onSubmit={handleSubmit} className="dk-profile-form">
                    ...
                    <div className="dk-profile-hero-card">
                        <div className="hero-content">
                                ...
                                <div className="avatar-circle">
                                    {uploadingAvatar && (
                                        <div className="avatar-overlay">
                                            <Loader2 className="spin-icon text-white" size={24} />
                                        </div>
                                    )}
                                    {formData?.avatarUrl ? (
                            ...
                            <div className="hero-action-section">
                                <button type="submit" disabled={updating} className="dk-btn-save">
                                    {updating ? <Loader2 className="spin-icon" size={18} /> : <Save size={18} />}
                                    {updating ? 'Saving...' : 'Save Blueprint'}
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="dk-profile-grid">
                        ...
                        {(isTourist || isResident) && (
                            <div className="dk-profile-card full-width">
                                <div className="card-header">
