...
export { default as VisaPermissionsPage } from './pages/VisaPermissions/VisaPermissions';
...
export { default as PartnershipsPage } from './pages/Partnerships/Partnerships';
export { default as InvestmentsPage } from './pages/Investments/Investments';
export { default as JobsPage } from './pages/Jobs/Jobs';
export { default as InternationalPage } from './pages/International/International';