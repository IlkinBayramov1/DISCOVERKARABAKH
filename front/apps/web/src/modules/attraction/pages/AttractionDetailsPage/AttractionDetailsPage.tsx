    ...
    return (
        <div className="attraction-detail-page">
            <main className="container">
                ...
                {/* IMAGE GALLERY SECTION - SINGLE IMAGE VIEW (Matches Tour Page) */}
                <section className="premium-image-gallery">
                    {images && images.length > 0 ? (
                        <div className="gallery-grid single-image">
                            {/* Main Image - Spans the full width */}
                ...
                <div className="premium-content-split">
                    ...
                    <div className="split-main">
                        ...
                        <div className="premium-card">
                            <h2><Info size={24} className="heading-icon"/> About</h2>
                        ...
                        <div className="premium-card reviews-card">
                            <h2><MessageCircle size={24} className="heading-icon"/> Reviews of Visitors</h2>
                    ...
                    <div className="split-sidebar">
                        ...
                        <div className="premium-card sticky-sidebar-card">
