...
export const attractionValidation = {
    createAttraction: Joi.object({
        ...
        audioUrl: Joi.string().uri({ allowRelative: true }).optional().allow('', null).empty(''),
        virtualTourUrl: Joi.string().uri({ allowRelative: true }).optional().allow('', null).empty(''),
        googleMapsUrl: Joi.string().uri({ allowRelative: true }).optional().allow('', null).empty(''),
        searchKeywords: Joi.string().max(500).optional().allow('', null),
